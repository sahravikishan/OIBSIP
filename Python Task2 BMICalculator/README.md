...
## 25. Screenshots
Sample trend visualization generated by the application's plotting engine:

![BMI Trend Chart Sample](screenshots/bmi_trend_chart.png)

*(Additional screenshots of the GUI window can be captured during demonstration and placed inside the `screenshots/` directory).*

---

## 26. Testing
A comprehensive test suite of **27 automated tests** verifies all aspects of the application.
...
- `test_chart.py`: 3 tests verifying threshold handling ($< 2$ records) and Matplotlib figure configuration.
- `test_gui.py`: 8 automated GUI integration tests verifying state changes, record insertion, combobox switching, and validation message handling.
