...
def create_chat_screenshot(output_path):
    ...
    # Room list section
    draw.text((20, 140), "CHAT ROOMS", font=get_font(11, bold=True), fill="#8da69e")
    draw.rounded_rectangle([245, 134, 272, 161], radius=6, fill="#1f332f", outline="#223d37")
    draw.text((254, 138), "+", font=get_font(14, bold=True), fill="#a7f3d0")
    ...
    draw.rounded_rectangle([w - 490, 228, w - 75, 270], radius=14, fill="#059669")
    draw.text((w - 475, 239), "Hi Bob! Yes, clean SVGs everywhere, emojis for chat 😄 👍", font=get_font(12), fill="#ffffff")
